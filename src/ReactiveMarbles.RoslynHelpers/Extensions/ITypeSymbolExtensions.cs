...
public static class ITypeSymbolExtensions
{
    ...
    /// <summary>
    /// Determines whether [contains fully qualified metadata name] [the specified name].
    /// </summary>
    /// <param name="symbol">The symbol.</param>
    /// <param name="name">The name.</param>
    /// <returns>
    ///   <c>true</c> if [contains fully qualified metadata name] [the specified name]; otherwise, <c>false</c>.
    /// </returns>
